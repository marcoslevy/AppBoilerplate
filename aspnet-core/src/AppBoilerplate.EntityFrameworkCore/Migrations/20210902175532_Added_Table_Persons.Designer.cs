...
namespace AppBoilerplate.Migrations
{
    ...
    [Migration("20210902175532_Added_Table_Persons")]
    partial class Added_Table_Persons
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppBoilerplate.Persons.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AppBoilerplate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AppBoilerplate.Authorization.Users.User", null)
                        .WithMany("Claims")
