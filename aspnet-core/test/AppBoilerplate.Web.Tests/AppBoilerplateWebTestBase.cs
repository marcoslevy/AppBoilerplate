...
using AppBoilerplate.Models.TokenAuth;
...
{
    public abstract class AppBoilerplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AppBoilerplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AppBoilerplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AppBoilerplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AppBoilerplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AppBoilerplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AppBoilerplateDbContext, Task<T>> func)
        {
            T result;
